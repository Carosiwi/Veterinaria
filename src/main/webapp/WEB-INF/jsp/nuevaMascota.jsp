            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    ...
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 font-weight-light mb-5">FORMULARIO DE REGISTRO DE NUEVA MASCOTA</p>
...
<h1>Mascota:</h1>
	<div class="container">
		<form:form action="agregarOtraMascota" method="POST" modelAttribute="mascota">
			<form:hidden path="id" value="${mascota.id}" />	

			<div class="form-group">
				<label>Nombre Mascota:</label>
				<form:input path="${mascota.nombreMascota}" cssClass="form-control" />
			</div>
			<div class="form-group">
				<label>Fecha de Nacimiento:</label>
				<form:input path="fecNacimiento" cssClass="form-control" />
			</div>
